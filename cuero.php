...
<body style="background-color: rgb(50,50,50)">
    <?php navBar();  ?>
    <br>
    <h2 style="text-align:center;color: #f0ad4e;font-family:Oswald;">RELOJES DE CUERO</h2>
    <hr class="solid" style="border-top: 2px solid #bbb;" >
    <br>
        <?php
$consulta = "SELECT * FROM productos WHERE categoria like'cuero%' and cantidad>0 ORDER BY id ASC";
